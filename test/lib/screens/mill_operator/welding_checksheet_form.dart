...
//            displayMessage();
    ...
    focusNodeCoilWeight = new FocusNode();
  }
                            ...
                            if (_odStart.text.isNotEmpty &&
                              ...
                              if (widget.pref.currentTube < qty) {
                                ...
                                if (data['formData']['nextTube'] == "") {
                                  //pop up to enter weight of coil
                                  showDialog(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        title: Text('Enter coil weight'),
                                        content: Container(
                                          height: 150,
                                          width: 500,
                                          child: Column(
                                        ...
                                        actions: [
                                          // update the weight of the current coil on the last tube
                                          RaisedButton(
                                            onPressed: () async {
                                              if (_coilWeight.text.isNotEmpty) {
