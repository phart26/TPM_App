<?php
    ...
    array_push($firstMesh,array("mesh_no" => $fil_mesh_top, "mesh_type" => $mesh['mesh']));
    ...
    array_push($firstMesh,array("mesh_no" => $fil_mesh_bot, "mesh_type" => $mesh['mesh']));
    ...
    array_push($firstMesh,array("mesh_no" => $drain_mesh_top, "mesh_type" => $mesh['mesh']));
    ...
    array_push($firstMesh,array("mesh_no" => $drain_mesh_bot, "mesh_type" => $mesh['mesh']));
    ...
    if(!empty($nextTubes)){
        ...
        array_push($currentMesh,array("mesh_no" => $filMeshTopLastTube, "mesh_type" => $mesh['mesh']));
        ...
        array_push($currentMesh,array("mesh_no" => $filMeshBotLastTube, "mesh_type" => $mesh['mesh']));
        ...
        array_push($currentMesh,array("mesh_no" => $drainMeshTopLastTube, "mesh_type" => $mesh['mesh']));
        ...
        array_push($currentMesh,array("mesh_no" => $drainMeshBotLastTube, "mesh_type" => $mesh['mesh']));
