...
<html lang="en">
    <head>
        ...
        <title><?= $header_tilte ?></title>
    </head>
  <body>
    <header class="straightNav center">
        <div class="menu">
    ...
    <div class="navBar">
        ...
        <nav id="nav" class="nav">
            <ul>
                <li><h3><a href="upcomingOrders.php" >Upcoming Orders</a></h3></li>
                <li><h3><a href="todTomOrders.php" >Shipping Today &nbsp</a></h3></li>
                <li><h3><a href="index.php" >All Orders</a></h3></li>
                <li><h3><a href="materialSearch.php">Material Search</a></h3></li>
                <li><h3><a href="testPDFGen.php">PDF Generator</a></h3></li>
                <li><h3><a href="partialShip_search.php">Shipments</a></h3></li>
                <li><h3><a href="millTable.php">Mills</a></h3></li>
            </ul>
        </nav>
    </div>
<!-- left Menu bar js >>  -->
