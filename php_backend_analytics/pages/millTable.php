                            ...
                            <?php foreach($millOne as $order): 
                                ...
                                if ($result= $conn -> query($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars(strval(getScrap($millOne)).'%'); ?></td>
                                    </tr> 
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                            ...
                            <?php foreach($millTwo as $order):
                                ...
                                if ($result= $conn -> query($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($dim); ?></td>
                                        <td><?php echo htmlspecialchars(getOp($order['job'])); ?></td>
                                        <td><?php echo htmlspecialchars(strval(getScrap($millTwo)).'%'); ?></td>
                                    </tr> 
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                            ...
                            <?php foreach($millThree as $order): 
                                ...
                                if ($result= $conn -> query($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($dim); ?></td>
                                        <td><?php echo htmlspecialchars(getOp($order['job'])); ?></td>
                                        <td><?php echo htmlspecialchars(strval(getScrap($millThree)).'%'); ?></td>
                                    </tr> 
                            ...
                            if ($result= $conn -> query($sql)) {
                                ...
                                if(mysqli_num_rows($result) == 0){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($dim); ?></td>
                                        <td><?php echo htmlspecialchars(getOp($order['job'])); ?></td>
                                        <td><?php echo htmlspecialchars(strval(getScrap($millFour)).'%'); ?></td>
                                    </tr> 
                        <?php endforeach; ?>
                    </tbody>
                </table>
                            ...
                            // getting od from part_tbl
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($dim); ?></td>
                                        <td><?php echo htmlspecialchars(getOp($order['job'])); ?></td>
                                        <td><?php echo htmlspecialchars(strval(getScrap($millFive)).'%'); ?></td>
                                    </tr> 
                        <?php endforeach; ?>
                    </tbody>
                </table>
